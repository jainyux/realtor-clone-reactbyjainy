...
{!geoLocationEnabled && (
    <div className='flex space-x-6 justify-start mb-6'>
        <div>
            ...
            <input type='number' id='latitude' value={latitude} onChange={onChange} required min="-90" max="90" className='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600  text-center'/>
        ...
        <div>
            ...
            <input type='number' id='longitude' value={longitude} onChange={onChange} required in="-180" max="180" className='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600  text-center'/>
...
<div className='mb-6'>
    ...
    className='w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150ms ease-in-out focus:bg-white focus:border-slate-600'/>
</div>
