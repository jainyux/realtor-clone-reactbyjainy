      ...
      <div className='w-full md:w-[50%] mt-6 px-3'>
        <form>
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6'>
            <p className='flex items-center'>Do you want to change your name? <span onClick={() => {changeDetail && onSubmit();
        ...
        <button type="submit" className='w-full bg-blue-600 text-white uppercase px-7 py-3 text-xm font-medium rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'> 
